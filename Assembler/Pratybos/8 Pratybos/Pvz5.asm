...
.data
	duom	db "duom.txt",0		;duomenø failo pavadinimas, pasibaigiantis nuliniu simboliu (C sintakse - '\0')
...
;*****************************************************
	...
	CMP	ax, raBufDydis			;jeigu vyko darbas su pilnu buferiu -> ið duomenø failo buvo nuskaitytas pilnas buferis ->
...
;á AX bus gràþinta, kiek simboliø nuskaityta
	...
	MOV	cl, skBufDydis		;cx - kiek baitø reikia nuskaityti ið failo
	MOV	ch, 0			;iðvalom vyresnájá cx baità
