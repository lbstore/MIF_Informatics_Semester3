...
ciklas:
	MOV dl, [bx]
	CMP	dl, '0'		;jei einamasis simbolis maþesnis uþ 'A'
	JB	spausdinti		;tokiu atveju tai ne didþioji raidë
	CMP	dl, '9'		;jei einamasis simbolis didesnis uþ 'Z'
	JA	spausdinti		;tokiu atveju tai ne didþioji raidë
	CMP	dl, '0'
	JE nuli
	CMP	dl, '1'
	JE viena
