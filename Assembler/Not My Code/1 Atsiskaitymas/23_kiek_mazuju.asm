...
msg2 db 10,13,"mazuju raidziu skaicius $"
...
mov dx, offset msg1 		; i dx pakraunam pirmo pranesimo adresa
int 21h
...
cmp al, 'a' 		; tikrinam ar simbolis yra mazoji raide
jb readin 		; jei simbolio kodas mazesnis uz 'a' koda tai skaitom toliau
cmp al, '{' 		; tikrinam ar simbolis yra didzioji raide
jb iftrue 		; simbolio kodas yra mazesnis uz '{' ir didesnis uz 'a' tai reiskia yra didzioji raide, todel pereinam prie iftrue zyma pazymeto kodo
...
mov dx, offset msg2 		; i dx pakraunam antro pranesimo adresa
int 21h 
