...
;užduotis: paversti skaičių nuo 0 iki 255 iš dešimtainės į dvejetainę
...
;-------------------------------------------------------------------------------
.code			
;PRIVAL_EIL Kodo Segmento pradžia, čia rašysim savo kodą
;Privalomos eilutės
...
add al, bl   ;pridedam einamąjį skaitmenį prie skaičiaus ir vėl sukam ciklą
jmp ciklas
